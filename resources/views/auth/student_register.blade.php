    ...
    <div class="col-lg-7">
        <div class="p-5">
            ...
            <form class="user" method="post" action="{{ url('/student-registration') }}">
                ...
                <button type="submit" class="btn btn-primary btn-user btn-block">Register as a Student</button>
            ...
            <div class="text-center">
                <a class="small" href="{{ url('/teacher-register') }}">Create a Teacher Account!</a>
            </div>
            <div class="text-center">
